...
const UpmePolicy = () => {
  return (
    <Box p={['20px', '20px 40px']}>
      ...
      <p>
        Effective date: <span className="date">2021-11-22</span>
      </p>
      <p>
      ...
      <p>
        ...
        <b>
          <span className="url">Upme.com</span>
        </b>{' '}
      ...
      <p>
        <b>SERVICE</b> means the <span className="url">Upme.com</span> website
        operated by <span className="company-name">Geek Hub Solution JSC</span>.
      </p>
      <p>
      ...
      <p>
        <span className="company-name">Geek Hub Solution JSC</span> uses the
      ...
      <p>
        If you are located outside <span className="country-name">Vietnam</span>{' '}
        and choose to provide information to us, please note that we transfer
        the data, including Personal Data, to{' '}
        <span className="country-name">Vietnam</span> and process it there.
      </p>
      <p>
      ...
      <p>
        <span className="company-name">Geek Hub Solution JSC</span> will take
      ...
      <p>
        <b>
          0.3. To stop selling your personal information. You are the only owner
      ...
      <div id="payments">
        <p>
          <span className="num">17</span>. <b>Payments</b>
        </p>
        <p>
      ...
      <p>
        <span className="num">18</span>. <b>Links to Other Sites</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">20</span>. <b>Changes to This Privacy Policy</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">21</span>. <b>Contact Us</b>
      </p>
      <p>
