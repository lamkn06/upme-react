...
const UpmeTerms = () => {
  return (
    <Box p={['20px', '20px 40px']}>
      ...
      <p>
        Last updated: <span className="date">2021-11-22</span>
      </p>
      <p>
      ...
      <p>
        Welcome to{' '}
        <b>
          <span className="company-name">Geek Hub Solution JSC</span>
        </b>{' '}
        (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        ...
        <b>
          <span className="url">Upme.cloud</span>
        </b>{' '}
      ...
      <div id="purchases">
        <p>
          <span className="num">3</span>. <b>Purchases</b>
        </p>
        <p>
      ...
      <div id="subscriptions">
        <p>
          <span className="num">5</span>. <b>Subscriptions</b>
        </p>
        <p>
        ...
        <p>
          ...
          <span className="company-name">Geek Hub Solution JSC</span> to charge
          all Subscription fees incurred through your account to any such
          payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason,{' '}
          <span className="company-name">Geek Hub Solution JSC</span> reserves
          the right to terminate your access to the Service with immediate
          effect.
        </p>
        <p>
          <span className="num">6</span>. <b>Free Trial</b>
        </p>
        <p>
          <span className="company-name">Geek Hub Solution JSC</span> may, at
        ...
        <p>
          ...
          <span className="company-name">Geek Hub Solution JSC</span> until Free
        ...
        <p>
          ...
          <span className="company-name">Geek Hub Solution JSC</span> reserves
          the right to (i) modify Terms of Service of Free Trial offer, or (ii)
          cancel such Free Trial offer.
        </p>
        <p>
          <span className="num">7</span>. <b>Fee Changes</b>
        </p>
        <p>
          <span className="company-name">Geek Hub Solution JSC</span>, in its
          sole discretion and at any time, may modify Subscription fees for the
          Subscriptions. Any Subscription fee change will become effective at
          the end of the then-current Billing Cycle.
        </p>
        <p>
          <span className="company-name">Geek Hub Solution JSC</span> will
      ...
      <div id="refunds">
        <p>
          <span className="num">8</span>. <b>Refunds</b>
        </p>
        <p>
          We issue refunds for Contracts within{' '}
          <b>
            <span className="refund-days">30</span> days
          </b>{' '}
      ...
      <div id="tc-content">
        <p>
          <span className="num">9</span>. <b>Content</b>
        </p>
        <p>
        ...
        <p>
          <span className="company-name">Geek Hub Solution JSC</span> has the
        ...
        <p>
          ...
          of <span className="company-name">Geek Hub Solution JSC</span> or used
      ...
      <p>
        <span className="num">10</span>. <b>Prohibited Uses</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">11</span>. <b>Analytics</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">12</span>. <b>No Use By Minors</b>
      </p>
      <p>
      ...
      <div id="account">
        <p>
          <span className="num">13</span>. <b>Accounts</b>
        </p>
        <p>
      ...
      <p>
        <span className="num">14</span>. <b>Intellectual Property</b>
      </p>
      <p>
        ...
        <span className="company-name">Geek Hub Solution JSC</span> and its
        licensors. Service is protected by copyright, trademark, and other laws
        of <span className="country" /> and foreign countries. Our trademarks
        may not be used in connection with any product or service without the
        prior written consent of{' '}
        <span className="company-name">Geek Hub Solution JSC</span>.
      </p>
      <p>
        <span className="num">15</span>. <b>Copyright Policy</b>
      </p>
      <p>
      ...
      <p>
        ...
        to <span className="email">hello@upme.cloud</span>, with the subject
      ...
      <p>
        <span className="num">17</span>. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at{' '}
        <span className="email">hello@upme.cloud</span> or via third party sites
        and tools with information and feedback concerning errors, suggestions
        for improvements, ideas, problems, complaints, and other matters related
        ...
        contain confidential information or proprietary information from you or
        any third party; and (iv) Company is not under any obligation of
        confidentiality with respect to the Feedback. In the event the transfer
      ...
      <p>
        <span className="num">18</span>. <b>Links To Other Web Sites</b>
      </p>
      <p>
      ...
      <p>
        <span className="company-name">Geek Hub Solution JSC</span> has no
      ...
      <p>
        <span className="num">19</span>. <b>Disclaimer Of Warranty</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">20</span>. <b>Limitation Of Liability</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">21</span>. <b>Termination</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">22</span>. <b>Governing Law</b>
      </p>
      <p>
        These Terms shall be governed and construed in accordance with the laws
        of <span className="country-name">Vietnam</span>, which governing law
      ...
      <p>
        <span className="num">23</span>. <b>Changes To Service</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">24</span>. <b>Amendments To Terms</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">25</span>. <b>Waiver And Severability</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">26</span>. <b>Acknowledgement</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">27</span>. <b>Contact Us</b>
      </p>
      <p>
